...
class IloscModal(ui.Modal, title="Kalkulator"):
    def __init__(self, nazwa, cena):
        ...
        self.nazwa = nazwa
        self.cena = cena
        self.ilosc = ui.TextInput(label="Podaj ilość", placeholder="Np. 1, 2, 5...", default="1", min_length=1, max_length=3)
...
class ProduktSelect(ui.Select):
    def __init__(self):
        ...
        super().__init__(placeholder="🛒 Wybierz pojedynczy produkt...", options=options)
...
# --- GŁÓWNY WIDOK POD MENU ---
class MainView(ui.View):
    def __init__(self):
        super().__init__(timeout=None)
        # Dodajemy oba selecty do jednej wiadomości pod menu
...
async def menu(interaction: discord.Interaction):
    ...
    # Budowanie sekcji z dużymi nagłówkami i pogrubieniem
